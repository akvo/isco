...
answers = [
    {"comment": None, "question": 1, "repeat_index": "0", "value": "Option 1"},
    {
    ...
    {"question": 4, "repeat_index": "0", "comment": "Q4 comment", "value": 25},
    {"question": 5, "repeat_index": "0", "comment": "Q5 comment", "value": 75},
    {"question": 6, "repeat_index": "0", "comment": None, "value": [2, 12]},
    {
        "question": 7,
        "repeat_index": "0",
        "comment": None,
...
class TestAnswerAppendValueFunction:
    ...
    async def test_add_update_answer(self, session: Session) -> None:
        ...
        assert "data" in res
        assert "count" in res
        res = crud_data.get_data_by_id(session=session, id=data.id)
    ...
    @pytest.mark.asyncio
    async def test_downnload_and_check_exist_data(
