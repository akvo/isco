...
const faqEn = [
    {
        ...
        <Fragment>
            ...
            <img height="400px" className="img img-shadows" src={require('../sass/images/faq-download-form.png')}/><br/><br/>
        ...
        <Fragment>
            ...
            <img height="120px" className="img img-shadows" src={require('../sass/images/faq-repeat-group.png')}/><br/><br/>
